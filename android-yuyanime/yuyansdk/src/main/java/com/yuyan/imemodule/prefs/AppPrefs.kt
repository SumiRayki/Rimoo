...
class AppPrefs(private val sharedPreferences: SharedPreferences) {
    ...
    inner class Internal : ManagedPreferenceInternal(sharedPreferences) {
        ...
        val keyboardWidthRatio = float("keyboard_width_ratio", 1f)     //键盘宽度比例
        val keyboardWidthRatioLandscape = float("keyboard_width_ratio_landscape", 0.7f)     //键盘宽度比例:横屏
        val keyboardWidthRatioFloat = float("keyboard_width_ratio_float", 1f)     //悬浮键盘宽度比例
        val keyboardWidthRatioLandscapeFloat = float("keyboard_width_ratio_landscape_float", 1f)     //悬浮键盘宽度比例:横屏
