...
Name "Rimoo ${WEASEL_VERSION}"

; The file to write
OutFile "archives\rimoo-${PRODUCT_VERSION}-installer.exe"

VIProductVersion "${WEASEL_VERSION}.${WEASEL_BUILD}"
VIAddVersionKey /LANG=2052 "ProductName" "Rimoo"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "Rimoo 輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【Rimoo】說明書"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【Rimoo】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【Rimoo】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【Rimoo】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【Rimoo】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "Rimoo 算法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【Rimoo】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【Rimoo】程序文件夾"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【Rimoo】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載 Rimoo"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的 Rimoo。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
LangString SYSTEMVERSIONNOTOK ${LANG_TRADCHINESE} "您的系统不被支持，最低系統要求:Windows 8.1!"

!insertmacro MUI_LANGUAGE "SimpChinese"
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "Rimoo 输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【Rimoo】说明书"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【Rimoo】输入法设定"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【Rimoo】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【Rimoo】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【Rimoo】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "Rimoo 算法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【Rimoo】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【Rimoo】程序文件夹"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【Rimoo】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载 Rimoo"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的 Rimoo。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
LangString SYSTEMVERSIONNOTOK ${LANG_SIMPCHINESE} "您的系統不被支持，最低系统要求:Windows 8.1!"

!insertmacro MUI_LANGUAGE "English"
LangString DISPLAYNAME ${LANG_ENGLISH} "Rimoo"
LangString LNKFORMANUAL ${LANG_ENGLISH} "Rimoo Manual"
LangString LNKFORSETTING ${LANG_ENGLISH} "Rimoo Settings"
LangString LNKFORDICT ${LANG_ENGLISH} "Rimoo Dictionary Manager"
LangString LNKFORSYNC ${LANG_ENGLISH} "Rimoo Sync User Profile"
LangString LNKFORDEPLOY ${LANG_ENGLISH} "Rimoo Deploy"
LangString LNKFORSERVER ${LANG_ENGLISH} "Rimoo Server"
LangString LNKFORUSERFOLDER ${LANG_ENGLISH} "Rimoo User Folder"
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "Rimoo App Folder"
LangString LNKFORSETUP ${LANG_ENGLISH} "Rimoo Installation Preference"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall Rimoo"
LangString CONFIRMATION ${LANG_ENGLISH} "Before installation, please uninstall the old version of Rimoo.$\n$\nPress 'OK' to remove the old version, or 'Cancel' to abort installation."
